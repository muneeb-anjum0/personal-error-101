...
export const generatedProjectDraftSchema = z.object({
  ...
  problem: z.string().max(2200),
  solution: z.string().max(2200),
  features: z.array(z.string().max(600)).max(12),
  architecture: z.array(z.string().max(600)).max(12),
  challenges: z.array(z.string().max(600)).max(12),
